...
#    print(df.describe())
    ...
    # ATTACK 1
    # Only select relevant features for the attack
    df_attack1 = df[["DATETIME", " L_T7", " F_PU10", " S_PU10", " F_PU11", " S_PU11", " P_J317", " L_T1", " ATT_FLAG"]]
    ...
    # ATTACK 2
    # Only select relevant features for the attack
    df_attack2 = df[["DATETIME", " L_T7", " F_PU10", " S_PU10", " F_PU11", " S_PU11", " P_J317", " L_T1", " ATT_FLAG"]]
    # Only select dates around the attack
    ...
    # ATTACK 3
    # Only select relevant features for the attack
    df_attack3 = df[["DATETIME", " L_T1", " F_PU1", " S_PU1", " F_PU2", " S_PU2", " ATT_FLAG"]]
    # Only select dates around the attack
    ...
    # ATTACK 4
    # Only select relevant features for the attack
    df_attack4 = df[["DATETIME", " L_T1", " F_PU1", " S_PU1", " F_PU2", " S_PU2", " ATT_FLAG"]]
    # Only select dates around the attack
    ...
    # ATTACK 6
    # Only select relevant features for the attack
    df_attack6 = df[["DATETIME", " L_T4", " F_PU6", " S_PU6", " F_PU7", " S_PU7", " ATT_FLAG"]]
    # Only select dates around the attack
    ...
    # ATTACK 7
    # Only select relevant features for the attack
    df_attack7 = df[["DATETIME", " L_T4", " F_PU6", " S_PU6", " F_PU7", " S_PU7", " ATT_FLAG"]]
    # Only select dates around the attack
